    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if isPresentation{
            ...
            if let toView = toVC?.view {
                ...
                UIView.animate(withDuration: 0.5, delay: 0, usingSpringWithDamping: 0.8, initialSpringVelocity: 5.0, options: UIView.AnimationOptions.transitionFlipFromBottom, animations: { () -> Void in
